...
Pyr_cs = plt.contour(T, P, Pyr_sm, levels=[0.02, 0.08, 0.18], colors="blue")
Grs_cs = plt.contour(T, P, Grs_sm, levels=[0.06, 0.16, 0.38], colors="lime")
...
plt.ylabel(r"P (bar)")
#plt.show()
plt.savefig("PT_path.pdf", bbox_inches="tight")